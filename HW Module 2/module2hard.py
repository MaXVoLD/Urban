def pass_word(n=20):  # Значение по умолчанию установил для удобства проверки дебагом, комментируя строку input
    ...
    password = 0  # переменная для хранения значений из списка list_password
