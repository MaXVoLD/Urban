...
class UrTube:
    ...
    def register(self, nickname, password, age):  # Функция для регистрации пользователей
        if self.log_in(nickname, password):  # Проверяем наличие пользователя
    ...
    def log_out(self):  # Разлогирование
